          ...
          body: Container(
              ...
              child:
                ...
                Container(
                    ...
                    padding:
                        getPadding(left: 10, top: 24, right: 10, bottom: 24),
                    ...
                    child: Column(
                        ...
                        children: [
                                  ...
                                  children: [
                                    Padding(
                                        ...
                                        child: Text("lbl_sagar_ratna".tr,
                                            ...
                                            style:
                                                AppStyle.txtPoppinsMedium25)),
                                    CustomButton(
                                        height: 41,
                                        width: 78,
                                        text: "lbl_02".tr,
                                        margin: getMargin(bottom: 3),
                                        variant: ButtonVariant.FillAmber200,
                          ...
                          CustomSearchView(
                              ...
                              variant: SearchViewVariant.OutlineBlack9000f,
                              padding: SearchViewPadding.PaddingT14,
                              fontStyle: SearchViewFontStyle.PoppinsRegular13,
                              prefix: Container(
                                  margin: getMargin(
                                      left: 17, top: 15, right: 11, bottom: 17),
                                  child: CustomImageView(
                              ...
                              suffix: Padding(
                                  ...
                                  child: IconButton(
                                      onPressed: () {
                                        controller
                                            .groupFiftyFiveController.clear;
                                      },
                ...
                CustomTextFormField(
                    ...
                    prefix: Container(
                        margin: getMargin(left: 15, right: 13, bottom: 10),
                        child: CustomImageView(
                            svgPath: ImageConstant.imgRefreshBlack900)),
                    prefixConstraints:
                        BoxConstraints(maxHeight: getVerticalSize(30.00))),
                CustomTextFormField(
                    width: 360,
                    focusNode: FocusNode(),
                    ...
                    fontStyle: TextFormFieldFontStyle.PoppinsRegular15,
                    prefix: Container(
                        margin: getMargin(left: 15, right: 10, bottom: 17),
                        child: CustomImageView(
                            svgPath: ImageConstant.imgQuestionBlack900)),
                    prefixConstraints:
                        BoxConstraints(maxHeight: getVerticalSize(37.00))),
                   CustomTextFormField(
                    width: 360,
                    focusNode: FocusNode(),
                        ...
                        child: IntrinsicWidth(
                            child: Row(
                              ...
                              Container(
                                  ...
                                  padding: getPadding(
                                      left: 3, top: 4, right: 3, bottom: 4),
                                  decoration: AppDecoration.outlineBlack90005
                                      .copyWith(
                                          borderRadius: BorderRadiusStyle
                                              .roundedBorder10),
                                  child: Row(children: [
