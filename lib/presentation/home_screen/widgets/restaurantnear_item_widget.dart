...
class RestaurantnearItemWidget extends StatelessWidget {
  RestaurantnearItemWidget(this.restaurantnearItemModelObj);

  RestaurantnearItemModel restaurantnearItemModelObj;
