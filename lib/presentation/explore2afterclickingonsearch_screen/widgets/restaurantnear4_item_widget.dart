...
class Restaurantnear4ItemWidget extends StatelessWidget {
  Restaurantnear4ItemWidget(this.restaurantnear4ItemModelObj);

  Restaurantnear4ItemModel restaurantnear4ItemModelObj;

  var controller = Get.find<Explore2afterclickingonsearchController>();
