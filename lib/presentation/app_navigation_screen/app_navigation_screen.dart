...
class AppNavigationScreen extends GetWidget<AppNavigationController> {
                      ...
                      child: Container(
                          ...
                          child: Column(
                              ...
                              children: [
                                ...
                                GestureDetector(
                                    onTap: () {
                                      onTapExplore2AfterClickingonSearch();
                                    },
                                    child: Container(
                                        width: getHorizontalSize(375.00),
                                        decoration: AppDecoration.fillWhiteA700,
                                              ...
                                              Align(
                                                  ...
                                                  child: Padding(
                                                      padding: getPadding(
                                                          ...
                                                          bottom: 10),
                                                      child: Text(
                                                          "msg_explore2afterclickingonsearch"
                                                              .tr,
                                                          overflow: TextOverflow
                                                              .ellipsis,
                                                          textAlign:
  ...
  onTapHome2AfterClickingonText() {
    Get.toNamed(AppRoutes.home2afterclickingontextScreen);
  }

  onTapExplore2AfterClickingonSearch() {
    Get.toNamed(AppRoutes.explore2afterclickingonsearchScreen);
  }
  ...
  onTapRestaurantMap() {
    Get.toNamed(AppRoutes.restaurantmapScreen);
  }
