...
class DrawerItems
{
  ...
  static  const Pre_Order=  DrawerItem(title: 'Pre-Order', icon: Icons.add_shopping_cart_rounded);
  static  const Offers =  DrawerItem(title: 'Offers & Promos', icon: Icons.local_offer_rounded);
